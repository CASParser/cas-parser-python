...
__all__ = ["NsdlResource", "AsyncNsdlResource"]
...
class NsdlResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> NsdlResourceWithRawResponse:
        ...
        """
        return NsdlResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> NsdlResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/cas-parser-python#with_streaming_response
        """
        return NsdlResourceWithStreamingResponse(self)
    ...
    def parse(
        ...
        *,
        ...
        return self._post(
            "/v4/nsdl/parse",
            body=maybe_transform(body, nsdl_parse_params.NsdlParseParams),
            files=files,
...
class AsyncNsdlResource(AsyncAPIResource):
    ...
    def with_raw_response(self) -> AsyncNsdlResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/cas-parser-python#accessing-raw-response-data-eg-headers
        """
        return AsyncNsdlResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncNsdlResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/cas-parser-python#with_streaming_response
        """
        return AsyncNsdlResourceWithStreamingResponse(self)
    ...
    async def parse(
        ...
        *,
        ...
        return await self._post(
            "/v4/nsdl/parse",
            body=await async_maybe_transform(body, nsdl_parse_params.NsdlParseParams),
            files=files,
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class NsdlResourceWithRawResponse:
    def __init__(self, nsdl: NsdlResource) -> None:
        self._nsdl = nsdl
...
class AsyncNsdlResourceWithRawResponse:
    def __init__(self, nsdl: AsyncNsdlResource) -> None:
        self._nsdl = nsdl
...
class NsdlResourceWithStreamingResponse:
    def __init__(self, nsdl: NsdlResource) -> None:
        self._nsdl = nsdl
...
class AsyncNsdlResourceWithStreamingResponse:
    def __init__(self, nsdl: AsyncNsdlResource) -> None:
        self._nsdl = nsdl
